...
本文側の章タイトル（h1）の 3 案を次ページ以降に示す。h1 は章カウンターを増分するため、見本では番号が 2〜4 と進むが、これはカウンター仕様によるもので装飾の一部ではない。本章冒頭の「1. 装飾バリアント見本」が現行スタイル（下罫線のみ）である。

<p class="sample-label page-break">h1 A 案: 全幅淡色グラデ帯＋角落とし＋左罫線</p>

<h1 class="variant-a">実践的な技術書組版</h1>

章見出し直後の本文はこのように続く。帯が章の開始を面で示し、右上の角落としが遊び心を添える。

<p class="sample-label page-break">h1 B 案: 縁取り特大番号＋下二重罫線（扉 C 案と響き合う）</p>

<h1 class="variant-b">実践的な技術書組版</h1>

章見出し直後の本文はこのように続く。縁取りの特大番号が扉の縁取り数字と呼応し、章の統一感を作る。

<p class="sample-label page-break">h1 C 案: 角落とし番号プレート大版（h2 B 案と相似形）</p>

<h1 class="variant-c">実践的な技術書組版</h1>

章見出し直後の本文はこのように続く。節見出しの番号プレートと相似形になり、階層の連続感を作る。
